    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener("profileUpdated", this, { _, _ ->
            viewModel.fetchUserDetails(fUser.uid) { fullName, userName, profileImage, isVerified ->
                run {
                    ...
                    binding.userProfileImage.load(profileImage)
        ...
        binding.verifyNow.setOnClickListener {
            ...
            alertDialog.setMessage(
                "Once you click verify, an email will be sent to your authenticated email. " +
            ...
            binding.verifyUser.setOnClickListener {
                Toast.makeText(
                    requireContext(),
                    if (verify) "You are verified" else "You are not verified",
                    Toast.LENGTH_SHORT
                ).show()
            }
            ...
            listOf(
                ...
                view.setOnClickListener {
                    ...
                    val fragment =
                        if (view == binding.settings) SettingsFragment() else ComingSoonFragment()
